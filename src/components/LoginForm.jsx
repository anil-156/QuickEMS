...
import { ArrowLeftIcon, EyeIcon, EyeOffIcon, Loader2Icon, LoaderIcon } from 'lucide-react'
    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <form className='space-y-5' onSubmit={handleSubmit}>
         ...
         duration-200 shadow-lg shadow-indigo-500/25 active:scale-[0.98] flex items-center justify-center'>
