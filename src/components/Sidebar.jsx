...
const SideBar = () => {
    ...
    const sidebarContent=(
        ...
        <div className='px-5 pt-6 pb-5 border-b border-white/6'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-3'>
                ...
                <div>
                <p className='font-semibold text-[13px] text-white tracking-wide'>Employment MS</p>
                <p className='text-[11px] text-slate-500 font-medium'>Management Systems</p>
              </div>
              </div>
        ...
        {/*Navigation List*/}
        <div className='flex-1 px- space-y-5 overflow-y-auto'>
          {navItems.map((item)=>{
            ...
            return(
              ...
              "text-slate-300 hover:text-white hover:bg-white/4"}`}>
                {isActive && <div className='absolute left-0 top-1/2-translate-y-1/2 w-0.75 h-5 
        ...
        <div className='p-3 border-t border-white/6'>
          <button onClick = {handleLogout} className='flex items-center gap-3 w-full px-3 py-2.5 rounded-md 
          text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 t
          ransition-all duration-150'>
